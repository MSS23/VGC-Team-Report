...
// src/lib/utils/translate-move.ts). Values are the ZH display name,
// falling back to the canonical English name when no translation exists.

const MOVE_NAMES_ZH: Record<string, string> = {
  "pound": "拍击",
  "karatechop": "空手劈",
  "doubleslap": "连环巴掌",
  "cometpunch": "连续拳",
  ...
  "lightofruin": "破灭之光",
  "originpulse": "根源波动",
  "precipiceblades": "断崖之剑",
  "dragonascent": "画龙点睛",
  "hyperspacefury": "异次元猛攻",
  "breakneckblitz": "究极无敌大冲撞",
  "alloutpummeling": "全力无双激烈拳",
  "supersonicskystrike": "极速俯冲轰烈撞",
  "aciddownpour": "强酸剧毒灭绝雨",
  "tectonicrage": "地隆啸天大终结",
  "continentalcrush": "毁天灭地巨岩坠",
  "savagespinout": "绝对捕食回旋斩",
  "neverendingnightmare": "无尽暗夜之诱惑",
  "corkscrewcrash": "超绝螺旋连击",
  "infernooverdrive": "超强极限爆焰弹",
  "hydrovortex": "超级水流大漩涡",
  "bloomdoom": "绚烂缤纷花怒放",
  "gigavolthavoc": "终极伏特狂雷闪",
  "shatteredpsyche": "至高精神破坏波",
  "subzeroslammer": "激狂大地万里冰",
  "devastatingdrake": "究极巨龙震天地",
  "blackholeeclipse": "黑洞吞噬万物灭",
  "twinkletackle": "可爱星星飞天撞",
  ...
  "maliciousmoonsault": "极恶飞跃粉碎击",
  "oceanicoperetta": "海神庄严交响乐",
  "guardianofalola": "巨人卫士・阿罗拉",
  "soulstealing7starstrike": "七星夺魂腿",
  "stokedsparksurfer": "驾雷驭电戏冲浪",
  "pulverizingpancake": "认真起来大爆击",
  "extremeevoboost": "九彩升华齐聚顶",
  ...
  "naturesmadness": "自然之怒",
  "multiattack": "多属性攻击",
  "10000000voltthunderbolt": "千万伏特",
  "mindblown": "惊爆大头",
  "plasmafists": "等离子闪电拳",
  "photongeyser": "光子喷涌",
  "lightthatburnsthesky": "焚天灭世炽光爆",
  "searingsunrazesmash": "日光回旋下苍穹",
  "menacingmoonrazemaelstrom": "月华飞溅落灵霄",
  "letssnuggleforever": "亲密无间大乱揍",
  "splinteredstormshards": "狼啸石牙飓风暴",
  "clangoroussoulblaze": "炽魂热舞烈音爆",
  "zippyzap": "电电加速",
  "splishysplash": "滔滔冲浪",
  "floatyfall": "飘飘坠落",
  "pikapapow": "闪闪雷光",
