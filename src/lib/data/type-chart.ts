...
/**
 * Returns the combined effectiveness multiplier for a single attacking type
 * against a defender with one or two types.
 *
 * Examples:
 *   getEffectiveness("Fire", ["Grass"])           // 2
 *   getEffectiveness("Fire", ["Water", "Rock"])   // 0.25  (0.5 × 0.5)
 *   getEffectiveness("Electric", ["Ground"])      // 0
 */
