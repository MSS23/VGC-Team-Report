...
export const metadata: Metadata = {
  ...
  description: "The free VGC team report builder. Share Pokemon VGC teams with notes, matchup plans, damage calcs, and speed tiers. Supports Mega Evolution and all formats.",
