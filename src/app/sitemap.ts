...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/speed-tiers`, changeFrequency: "weekly", priority: 0.7, lastModified: now },
    { url: `${BASE}/compare`, changeFrequency: "monthly", priority: 0.6, lastModified: now },
    { url: `${BASE}/guides/how-to-write-a-vgc-team-report`, changeFrequency: "monthly", priority: 0.7, lastModified: now },
