    ...
    >
      ...
      <div className="px-5 sm:px-6 pt-5 flex items-center justify-between gap-3 flex-wrap">
        <div className="flex items-center gap-2.5">
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-extrabold rounded-full bg-accent text-accent-on shadow-sm shadow-accent/30 uppercase tracking-widest">
